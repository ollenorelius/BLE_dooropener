...
K_SYSCALL_DECLARE5(K_SYSCALL_CAN_SEND, can_send, int, struct device *, dev, const struct zcan_frame *, msg, s32_t, timeout, can_tx_callback_t, callback_isr, void *, callback_arg)
